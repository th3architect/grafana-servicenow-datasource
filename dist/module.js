...
function (_super) {
  ...
  ServiceNowQueryEditor.prototype.render = function () {
    ...
    if (query && query.servicenow && query.servicenow.type === 'table') {
      fieldsCtrl = react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_servicenow_Query__WEBPACK_IMPORTED_MODULE_3__["ServiceNowQueryFieldsCtrl"], {
    ...
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_servicenow_Query__WEBPACK_IMPORTED_MODULE_3__["ServiceNowQueryTableAndTypeCtrl"], {
      ...
      query: query,
      datasource: this.props.datasource
    }), fieldsCtrl, groupByCtrl, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_servicenow_Query__WEBPACK_IMPORTED_MODULE_3__["ServiceNowQueryQueryCtrl"], {
      onChange: this.props.onChange,
      query: query,
      datasource: this.props.datasource
      ...
      query: query,
      datasource: this.props.datasource
    }), react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_servicenow_Query__WEBPACK_IMPORTED_MODULE_3__["ServiceNowQueryOrderByCtrl"], {
      onChange: this.props.onChange,
      query: query,
      datasource: this.props.datasource
...
/** @class */
function () {
  function ServiceNowDataSource(instanceSettings, templateSrv) {
  ...
  ServiceNowDataSource.prototype.doQueries = function (queries, options) {
    ...
    return queries.map(function (query) {
      var servicenowQueryItem = query.servicenow;

      if (servicenowQueryItem && servicenowQueryItem.query) {
        servicenowQueryItem.query = _this.templateSrv.replace(servicenowQueryItem.query, {}, 'glob');
      }

      if (servicenowQueryItem && servicenowQueryItem.filters) {
        servicenowQueryItem.filters = servicenowQueryItem.filters.map(function (filter) {
          filter.value = _this.templateSrv.replace(filter.value, {}, 'glob');
          return filter;
        });
      }

      var serviceNowQuery = new _ServiceNowQuery__WEBPACK_IMPORTED_MODULE_2__["ServiceNowQuery"](servicenowQueryItem);
        ...
        res.result.data.result.forEach(function (item, index) {
          if (index === 0) {
            if (res && res.query && res.query.servicenow && res.query.servicenow.groupBy) {
              res.query.servicenow.groupBy.split(",").forEach(function (groupItem) {
          ...
          if (item && item.stats) {
            ...
            var outArray_1 = [];
            item.groupby_fields.forEach(function (groupField) {
              outArray_1.push(groupField.display_value || groupField.value);
            });
            outArray_1.push(value);

            _this.output.rows.push(outArray_1);
          }
        });
      } else {
        res.result.data.result.forEach(function (item, index) {
...
function (_super) {
  ...
  function Datasource(instanceSettings, templateSrv) {
    ...
    _this.serviceNowDataSource = new _ServiceNowDatasource__WEBPACK_IMPORTED_MODULE_3__["ServiceNowDataSource"](_this.instanceSettings, _this.templateSrv);
    return _this;
  }
